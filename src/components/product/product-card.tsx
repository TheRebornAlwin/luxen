      ...
      >
        <div className="relative h-full rounded-2xl overflow-hidden bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] p-4 group hover:border-gold/20 transition-all duration-700">
          ...
          <div className="relative aspect-square rounded-xl bg-gradient-to-b from-midnight-navy/40 to-space-black/40 overflow-hidden mb-4 flex items-center justify-center">
            ...
            <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 bg-gradient-to-t from-electric-violet/8 via-transparent to-gold/5" />
            ...
            <motion.div
              ...
              className="relative"
            >
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-white/15 group-hover:text-gold/30 transition-colors duration-700">
                <circle cx="12" cy="12" r="10" />
                <path d="M12 2a7 7 0 017 7" />
                <circle cx="12" cy="12" r="3" />
              </svg>

              {/* Glow behind product on hover */}
              <div className="absolute inset-0 -m-4 rounded-full bg-gold/0 group-hover:bg-gold/10 blur-xl transition-all duration-700" />
            </motion.div>

            {/* Discount badge */}
            {discount > 0 && (
              <span className="absolute top-3 right-3 text-[10px] bg-gold/90 text-space-black font-bold px-2.5 py-0.5 rounded-full shadow-[0_0_12px_rgba(201,168,76,0.3)]">
                -{discount}%
              </span>
            )}
          </div>
